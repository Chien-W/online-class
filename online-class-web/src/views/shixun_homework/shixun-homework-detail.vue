...
export default {
  ...
  data(){
    return{
      ...
      tableData: [
        {id:'1',name: '张三',num: '1855010216',state:'已提交'},
        {id:'2',name: '张三',num: '1855010216',state:'已提交'},
        {id:'3',name: '张三',num: '1855010216',state:'已提交'},
        {id:'4',name: '张三',num: '1855010216',state:'未提交'},
        {id:'5',name: '张三',num: '1855010216',state:'未提交'},
      ]
    }
  },
  methods:{
