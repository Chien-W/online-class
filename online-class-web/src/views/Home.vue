      ...
      <div class="home">
        <el-card class="box-card">
          <div slot="header" class="clearfix" id="container">
            <span v-for="(item,index) in options" id="index" :key="index" @click="choose(item)" style="margin-right: 40px;font-size: 15px;cursor: pointer">
              {{ item.name }}
            </span>
<!--            <el-row>-->
<!--              <el-col :span="3">-->
<!--                <span style="font-size: 15px;cursor: pointer">全部</span>-->
<!--              </el-col>-->
<!--              <el-col :span="3">-->
<!--                <span style="font-size: 15px;cursor: pointer">我管理的</span>-->
<!--              </el-col>-->
<!--              <el-col :span="3">-->
<!--                <span style="font-size: 15px;cursor: pointer">我学习的</span>-->
<!--              </el-col>-->
<!--            </el-row>-->
          </div>
          <div id="container2">
            <span v-for="(item,index) in options2" id="index2" :key="index" @click="choose(item)"style="margin-right: 40px;font-size: 15px;cursor: pointer">
              {{ item.name }}
            </span>
<!--            <el-row>-->
<!--              <el-col :span="2">-->
...
<!--              </el-col>-->
<!--              <el-col :span="3">-->
<!--                <span style="font-size: 15px;cursor: pointer">正在进行</span>-->
<!--              </el-col>-->
<!--              <el-col :span="3">-->
<!--                <span style="font-size: 15px;cursor: pointer">已结束</span>-->
<!--              </el-col>-->
<!--            </el-row>-->
          </div>
          ...
          <div v-else>
            <el-row  :gutter="20">
              <el-col :span="6" v-for="index in courseData" style="margin: 5px 0;">
                <el-card :body-style="{ padding: '20px' }" shadow="hover" @click.native="openCard" style="cursor: pointer;border-radius: 10px;">
